package com.example.waterrefillapijava.meterreading.controller;
...
import com.example.waterrefillapijava.meterreading.dto.MeterReadingRequest;
import com.example.waterrefillapijava.meterreading.dto.MeterReadingResponse;
import com.example.waterrefillapijava.shared.dto.PageResponse;
import com.example.waterrefillapijava.meterreading.service.MeterReadingService;
...
public class MeterReadingController {
	...
	public ResponseEntity<?> permanentDelete(@PathVariable final Long id) {
		...
		return ResponseEntity.ok(new com.example.waterrefillapijava.shared.dto.MessageResponse("Meter reading permanently deleted successfully."));
	}
}
