...
import com.example.waterrefillapijava.order.dto.OrderItemResponse;
...
public class OrderService {
	...
	public void permanentDelete(final Long id) {
		final Order order = orderRepository.findByIdWithDetails(id);
		if (order == null || !order.isDeleted()) {
			throw new com.example.waterrefillapijava.shared.exception.ConflictException("Order must be archived before permanent deletion.");
		}
